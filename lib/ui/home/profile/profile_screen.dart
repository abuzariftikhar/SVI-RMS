...
class _ProfileScreenState extends State<ProfileScreen> {
  late GetVendorDetail getVendorDetail;

  bool _smsNotificationOn = true;
  @override
  Widget build(BuildContext context) {
    return FutureBuilder<GetVendorDetail>(
                      ...
                      [
                        ...
                        Row(
                          ...
                          children: [
                            Text(
                              // "Ahmed Hamid",
                              snapshot.data!.basicInfo!["first_name"],
                            ...
                            // Text(
                            //   // "Ahmed Hamid",
                            //   snapshot.data!.basicInfo!["last_name"],
                            //   textAlign: TextAlign.center,
                            //   style: const TextStyle(
                            //     fontWeight: FontWeight.bold,
                            //     fontSize: 22,
                          ...
                          children: [
                            Container(
                              ...
                              child: Text(
                                ...
                                snapshot
                                    .data?.basicInfo!["consultant_hired_from"],
                                textAlign: TextAlign.center,
                                style: const TextStyle(),
                              ),
                            ),
                                ...
                                ProfileTile(
                                  ...
                                  onTap: () {
                                    Navigator.pushNamed(
                                      context,
                                      AboutMeScreen.route,
                                      arguments: snapshot.data!.basicInfo,
                                    );
                                  },
