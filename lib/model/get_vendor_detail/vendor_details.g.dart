...
VendorDetails _$VendorDetailsFromJson(Map<String, dynamic> json) =>
    VendorDetails(
      ...
      vendorAttachments: (json['vendor_attachments'] as List<dynamic>)
          .map((e) => e == null
              ? null
      ...
      bankDetails: (json['bank_details'] as List<dynamic>)
          .map((e) =>
              e == null ? null : BankDetail.fromJson(e as Map<String, dynamic>))
          .toList(),
      ...
      tools: (json['tools'] as List<dynamic>)
          .map((e) =>
              e == null ? null : Tool.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
